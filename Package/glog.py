...
class FormViewClusterStartLog(tkinter.Frame):
    ...
    def build_gui(self):
        '''
        Build the graphical user interface of "FormViewClusterStartLog".
        '''
    ...
    def check_inputs(self, *args):
        '''
        Check the content of each input of "FormViewClusterStartLog" and do the actions linked to its value
        '''
    ...
    def execute(self, event=None):
        ...
        dialog_viewer = gdialogs.DialogViewer(self, cluster_file_path, self.wrapper_cluster_name.get())
