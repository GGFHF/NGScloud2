...
def install_toa(cluster_name, log, function=None):
    ...
    (toa_version, toa_url) = xconfiguration.get_bioinfo_app_data(xlib.get_toa_name())
...
def build_toa_installation_script(cluster_name, current_run_dir):
    ...
    try:
        ...
        with open(get_toa_installation_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
            ...
            script_file_id.write(f'    SUBJECT="{xlib.get_project_name()}: {xlib.get_toa_name()} installation"\n')
            message = xlib.get_mail_message_ok(f'{xlib.get_toa_name()} installation', cluster_name)
            ...
            script_file_id.write(f'    RECIPIENT={xconfiguration.get_contact_data()}\n')
            script_file_id.write(f'    SUBJECT="{xlib.get_project_name()}: {xlib.get_toa_name()} installation"\n')
            message = xlib.get_mail_message_wrong(f'{xlib.get_toa_name()} installation', cluster_name)
            script_file_id.write(f'    MESSAGE="{message}"\n')
            script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
        ...
        try:
            ...
            with open(get_recreate_toa_database_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_get_toa_process_recreate_toa_database_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_get_toa_process_recreate_toa_database_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_get_toa_process_recreate_toa_database_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_get_toa_process_recreate_toa_database_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_rebuild_toa_database_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_get_toa_process_rebuild_toa_database_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_get_toa_process_rebuild_toa_database_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_get_toa_process_rebuild_toa_database_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_get_toa_process_rebuild_toa_database_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_basic_data_download_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_download_basic_data_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_download_basic_data_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_download_basic_data_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_download_basic_data_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_basic_data_load_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_load_basic_data_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_load_basic_data_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_load_basic_data_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_load_basic_data_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_gymno_01_proteome_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_proteome_gymno_01_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_proteome_gymno_01_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_proteome_gymno_01_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_proteome_gymno_01_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_gymno_01_download_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_download_gymno_01_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_download_gymno_01_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_download_gymno_01_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_download_gymno_01_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_gymno_01_load_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_load_gymno_01_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_load_gymno_01_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_load_gymno_01_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_load_gymno_01_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_dicots_04_proteome_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_proteome_dicots_04_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_proteome_dicots_04_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_proteome_dicots_04_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_proteome_dicots_04_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_dicots_04_download_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_download_dicots_04_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_download_dicots_04_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_download_dicots_04_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_download_dicots_04_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_dicots_04_load_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_load_dicots_04_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_load_dicots_04_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_load_dicots_04_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_load_dicots_04_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_monocots_04_proteome_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_proteome_monocots_04_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_proteome_monocots_04_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_proteome_monocots_04_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_proteome_monocots_04_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_monocots_04_download_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_download_monocots_04_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_download_monocots_04_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_download_monocots_04_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_download_monocots_04_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_monocots_04_load_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_load_monocots_04_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_load_monocots_04_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_load_monocots_04_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_load_monocots_04_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_refseq_plant_proteome_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_proteome_refseq_plant_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_proteome_refseq_plant_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_proteome_refseq_plant_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_proteome_refseq_plant_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_nt_blastdb_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_blastdb_nt_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_blastdb_nt_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_blastdb_nt_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_blastdb_nt_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_viridiplantae_nucleotide_gi_gilist_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_gilist_viridiplantae_nucleotide_gi_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_gilist_viridiplantae_nucleotide_gi_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_gilist_viridiplantae_nucleotide_gi_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_gilist_viridiplantae_nucleotide_gi_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_nr_blastdb_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_blastdb_nr_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_blastdb_nr_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_blastdb_nr_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_blastdb_nr_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_viridiplantae_protein_gi_gilist_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_gilist_viridiplantae_protein_gi_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_gilist_viridiplantae_protein_gi_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_gene_download_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_download_gene_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_download_gene_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_download_gene_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_download_gene_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_gene_load_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_load_gene_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_load_gene_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_load_gene_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_load_gene_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_interpro_download_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_download_interpro_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_download_interpro_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_download_interpro_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_download_interpro_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_interpro_load_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_load_interpro_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_load_interpro_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_load_interpro_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_load_interpro_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_go_download_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_download_go_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_download_go_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_download_go_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_download_go_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
        ...
        try:
            ...
            with open(get_go_load_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                with open(get_toa_config_file(), mode='r', encoding='iso-8859-1', newline='\n') as toa_config_file_id:
                    ...
                    script_file_id.write( '    echo "$SEP"\n')
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_load_go_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_load_go_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                    script_file_id.write( '{0}\n'.format('    exit 0'))
                    script_file_id.write( '}\n')
                    ...
                    script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                    script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_load_go_name())))
                    script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_load_go_name(), cluster_name))))
                    script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                    script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                    script_file_id.write( '{0}\n'.format('    exit 3'))
                    script_file_id.write( '}\n')
    ...
    if OK:
        try:
            ...
            with open(get_nucleotide_pipeline_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                script_file_id.write( '    echo "$SEP"\n')
                script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_pipeline_nucleotide_name())))
                script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_pipeline_nucleotide_name(), cluster_name))))
                script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                script_file_id.write( '{0}\n'.format('    exit 0'))
                script_file_id.write( '}\n')
                ...
                script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_pipeline_nucleotide_name())))
                script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_pipeline_nucleotide_name(), cluster_name))))
                script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                script_file_id.write( '{0}\n'.format('    exit 3'))
                script_file_id.write( '}\n')
    ...
    if OK:
        try:
            ...
            with open(get_aminoacid_pipeline_script(), mode='w', encoding='iso-8859-1', newline='\n') as script_file_id:
                ...
                script_file_id.write( '    echo "$SEP"\n')
                script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_pipeline_aminoacid_name())))
                script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_ok(xlib.get_toa_process_pipeline_aminoacid_name(), cluster_name))))
                script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_OK'))
                script_file_id.write( '{0}\n'.format('    exit 0'))
                script_file_id.write( '}\n')
                ...
                script_file_id.write( '{0}\n'.format('    RECIPIENT={0}'.format(xconfiguration.get_contact_data())))
                script_file_id.write( '{0}\n'.format('    SUBJECT="{0}: TOA - {1}"'.format(xlib.get_project_name(), xlib.get_toa_process_pipeline_aminoacid_name())))
                script_file_id.write( '{0}\n'.format('    MESSAGE="{0}"'.format(xlib.get_mail_message_wrong(xlib.get_toa_process_pipeline_aminoacid_name(), cluster_name))))
                script_file_id.write( '    mail --append "Content-type: text/html;" --append "FROM:root@NGScloud2" --subject="$SUBJECT" "$RECIPIENT" <<< "$MESSAGE"\n')
                script_file_id.write( '{0}\n'.format('    touch $SCRIPT_STATUS_WRONG'))
                script_file_id.write( '{0}\n'.format('    exit 3'))
                script_file_id.write( '}\n')
